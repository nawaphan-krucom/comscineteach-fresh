          ...
          <div key={`table-${pageTransitionKey}`} className="hidden md:block overflow-x-auto custom-scrollbar bg-white rounded-2xl shadow-lg border border-slate-200 animate-fade-in">
            <table className="min-w-full text-sm">
              <thead className="bg-gradient-to-r from-indigo-50 via-blue-50 to-purple-50 border-b-2 border-indigo-200">
                <tr>
                  <th className="p-5 font-bold text-slate-800 text-left sticky left-0 bg-gradient-to-r from-indigo-50 to-blue-50 shadow-sm">
                    <div className="flex items-center gap-2">
                      <button
                  ...
                  <th className="p-5 font-bold text-slate-800 text-center">
                  ...
                  {unitsSummary.slice(0,5).map(({ unit, totalMaxScore }) => (
                    <th key={unit.id} className="p-5 font-bold text-slate-800 text-center">
                      <div className="flex items-center justify-center gap-2">
                  ...
                  <th className="p-5 font-bold text-slate-800 text-center" data-testid="gradebook-col-midterm">
                    <div className="flex items-center justify-center gap-2">
                  ...
                  <th className="p-5 font-bold text-slate-800 text-center" data-testid="gradebook-col-final">
                    <div className="flex items-center justify-center gap-2">
              ...
              <tbody>
                {paginatedStudents.map((student, index) => {
                  ...
                  return (
                    <tr key={student.id} className={`hover:bg-gradient-to-r hover:from-indigo-50/30 hover:to-purple-50/30 transition-all duration-300 border-b border-slate-100 last:border-b-0 ${index % 2 === 0 ? 'bg-white' : 'bg-slate-50/20'}`}>
                      <td className="p-5 font-semibold text-slate-800 sticky left-0 bg-white/90 backdrop-blur-sm shadow-sm">
                        <div className="flex items-center gap-3">
                          <button
                      ...
                      <td className="p-5 text-center">
                        <span className="bg-gradient-to-r from-blue-100 to-blue-200 rounded-xl px-4 py-2 font-medium text-blue-800 text-sm shadow-sm border border-blue-200">
                      ...
                      {unitsSummary.slice(0, 5).map(({ unit }) => {
                        ...
                        return (
                          <td key={unit.id} className="p-5 text-center">
                            <button
                      ...
                      <td className="p-5 text-center">
                        <div className="bg-gradient-to-r from-purple-100 to-indigo-200 rounded-xl px-4 py-3 font-medium font-bold text-purple-800 text-sm shadow-sm border border-purple-300">
                          <div className="text-lg" data-testid="gradebook-aggregate-score">{totalScore}/{totalMax}</div>
                          {showQuickActions && (
